...
export default function PublishGate({
  ...
  const checkPublishGate = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        logger.error('Publish gate check failed:', { data: result });
        setGateResult({
          canPublish: false,
      ...
      logger.error('Publish gate check error', { data: error instanceof Error ? error : new Error(String(error)) });
      setGateResult({
        canPublish: false,
  ...
  const handlePublish = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Publish error', { data: error instanceof Error ? error : new Error(String(error)) });
