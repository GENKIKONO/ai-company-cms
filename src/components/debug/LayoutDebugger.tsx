      ...
      <div className="absolute top-4 right-4 bg-white rounded-lg shadow-2xl p-6 max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {metrics && (
          <div className="space-y-6 font-mono text-sm">
            {/* Viewport Info */}
            <div>
              <h4 className="font-bold text-[var(--aio-primary)] mb-2">Viewport & Breakpoint</h4>
              <div className="bg-gray-50 p-3 rounded">
                <p>Size: {metrics.viewport.width} × {metrics.viewport.height}</p>
                <p>Breakpoint: <span className="font-bold text-[var(--aio-primary)]">{metrics.breakpoint}</span></p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t">
              <button
                ...
                className="bg-[var(--aio-primary)] text-white px-4 py-2 rounded mr-2 hover:bg-[var(--aio-primary-hover)]"
              >
                Remeasure
              </button>
              <button
