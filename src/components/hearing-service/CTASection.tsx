        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
            <Link
              ...
              className="inline-flex items-center justify-center font-bold text-xl px-10 py-5 bg-[var(--aio-primary)] hover:bg-[var(--aio-primary-hover)] text-[var(--text-on-primary)] rounded-2xl border-none shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              14日間無料で始める
            ...
            <Link
              ...
              className="inline-flex items-center justify-center font-bold text-xl px-10 py-5 bg-gray-100 border-2 border-gray-300 hover:bg-gray-200 hover:border-gray-400 text-[var(--text-on-primary)] rounded-2xl transition-all duration-300"
            >
              専門ヒアリング相談
            </Link>
          </div>
          ...
          <div className="bg-gray-50 rounded-3xl p-8 border border-gray-200 max-w-5xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold text-[var(--text-on-primary)] mb-10 text-center">申し込みは3ステップで完了</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-[var(--text-on-primary)] font-bold text-lg mb-3">プラン選択</h4>
                <p className="text-[var(--text-on-primary)] leading-relaxed">シングルまたは継続プランを選択</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-[var(--text-on-primary)] font-bold text-lg mb-3">基本情報入力</h4>
                <p className="text-[var(--text-on-primary)] leading-relaxed">会社概要とヒアリング希望日程</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-[var(--text-on-primary)] font-bold text-lg mb-3">日程確定</h4>
                <p className="text-[var(--text-on-primary)] leading-relaxed">担当者から連絡・ヒアリング実施</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-[var(--text-on-primary)]">
