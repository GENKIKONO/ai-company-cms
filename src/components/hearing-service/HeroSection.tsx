...
export default function HeroSection() {
  return (
    <section className="relative section-spacing-large overflow-hidden bg-gradient-to-br from-blue-50/80 via-white to-indigo-50/60">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-8 mb-12 text-sm text-gray-600">
            <div className="text-center">
              <div className="text-3xl font-bold text-[var(--bg-primary)] mb-1">1時間</div>
