    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 compact-section">
      ...
      <div className="wide-container text-left">
          ...
          <div className="measure-lead">
            <h1 className="headline ui-h1 jp-heading text-gray-900 leading-tight tracking-tight mb-6">
          ...
          {/* サブタイトル */}
          <div className="measure-lead">
            <p className="copy text-[15px] sm:text-base md:text-xl text-gray-600 mb-8 leading-7 sm:leading-8">
          ...
          <div className="mt-12 sm:mt-16">
            <HorizontalScroller ariaLabel="サービス特徴" className="sm:grid-cols-2 lg:grid-cols-3">
              <div className="snap-start min-w-[280px] sm:min-w-0 bg-white/60 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/50">
                ...
                <div className="jp-body text-[15px] sm:text-base text-gray-700 leading-6 sm:leading-7">AI最適化の専門スタッフが企業情報を丁寧にヒアリング</div>
              </div>
              <div className="snap-start min-w-[280px] sm:min-w-0 bg-white/60 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/50">
                <div className="jp-heading text-lg font-bold text-purple-600 mb-2">構造化登録</div>
                <div className="jp-body text-[15px] sm:text-base text-gray-700 leading-6 sm:leading-7">ヒアリング内容をJSON-LD形式で構造化・最適化して登録</div>
              </div>
              <div className="snap-start min-w-[280px] sm:min-w-0 bg-white/60 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/50">
                <div className="jp-heading text-lg font-bold text-indigo-600 mb-2">継続改善</div>
                <div className="jp-body text-[15px] sm:text-base text-gray-700 leading-6 sm:leading-7">定期的な情報更新とAI検索最適化のサポート</div>
              </div>
            </HorizontalScroller>
          </div>
      </div>
