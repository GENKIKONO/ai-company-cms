...
export default function ServiceImageUploader({ 
    ...
    try {
      ...
      if (currentImageUrl) {
        try {
          ...
          logger.warn('Failed to remove existing service image', { data: removeError });
        }
      }
      ...
      logger.error('Service image upload error:', { data: uploadError });
  ...
  const handleClear = async () => {
    ...
    try {
      ...
      if (removeError) {
        logger.warn('Failed to remove service image from storage', { data: removeError });
      }
      ...
      logger.error('Service image clear error:', { data: clearError });
