...
async function getOpsStatus(): Promise<StatusData | null> {
  try {
    ...
    logger.error('[getOpsStatus] Error', { data: error instanceof Error ? error : new Error(String(error)) });
    return null;
  }
}
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="space-y-2">
                ...
                <div>
                  <a
                    href="/ops/verify"
                    className="inline-block bg-[var(--aio-primary)] hover:bg-[var(--aio-primary-hover)] text-white px-4 py-2 rounded-md text-sm font-medium"
                  >
                    Verify に戻る
                  </a>
                </div>
