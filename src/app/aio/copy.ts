  ...
  flow: {
    ...
    steps: [
      ...
      },
      {
        step: 3,
        title: '公開・運用開始',
        description: 'SEO・AI検索・OGP（順次拡張予定）・サイトマップまで自動対応で即座に効果発揮。',
        details: [
          '検索エンジン・AI向けサイトマップ',
          'OGP・Twitter Card自動生成（順次拡張予定）',
          'リアルタイム更新・バージョン管理'
        ],
        color: 'indigo'
      }
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: 'リアルタイム更新に対応。フォームでの情報変更が即座にJSON-LD・OGP（順次拡張予定）・サイトマップに反映され、検索エンジンとAIプラットフォームへの情報提供が自動化されます。'
          }
        ]
      }
    ]
