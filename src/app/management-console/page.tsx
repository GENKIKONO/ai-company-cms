        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/management-console/settings" className="block">
            <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <div className="text-sm text-[var(--bg-primary)] font-medium flex items-center">
                設定を管理
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>登録組織数</span>
                <span className="font-semibold text-indigo-600">準備中</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>アクティブユーザー</span>
                <span className="font-semibold text-indigo-600">準備中</span>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-2">
              <Link href="/management-console/settings" className="block text-sm text-orange-600 hover:text-orange-700 font-medium">
                • ヒーロー画像を変更
              </Link>
              <Link href="/management-console/reports" className="block text-sm text-orange-600 hover:text-orange-700 font-medium">
                • 新しい通報を確認
              </Link>
              <Link href="/management-console/hearings" className="block text-sm text-orange-600 hover:text-orange-700 font-medium">
                • ヒアリング依頼を確認
              </Link>
              <Link href="/management-console/users" className="block text-sm text-orange-600 hover:text-orange-700 font-medium">
                • ユーザー権限を管理
              </Link>
            </div>
          </div>
