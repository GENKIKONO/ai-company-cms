...
export default function UsersManagementPage() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      logger.error('Fetch users error:', { data: err });
  ...
  const fetchUserDetails = async (userId: string) => {
    ...
    try {
      ...
      logger.error('Fetch user details error:', { data: err });
  ...
  const executeContentAction = async (
    ...
    try {
      ...
      logger.error('Content action error:', { data: err });
  ...
  const createProxyContent = async (formData: any) => {
    ...
    try {
      ...
      logger.error('Proxy content creation error:', { data: err });
  ...
  const changePlan = async (planData: any) => {
    ...
    try {
      ...
      logger.error('Plan change error:', { data: err });
