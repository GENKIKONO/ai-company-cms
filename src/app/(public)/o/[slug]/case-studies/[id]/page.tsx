...
async function getCaseStudyData(slug: string, caseStudyId: string): Promise<CaseStudyDetailData | null> {
  try {
    ...
    logger.error('Failed to fetch case study data', { data: error instanceof Error ? error : new Error(String(error)) });
    return null;
  }
}
              ...
              <div className="space-y-8">
                ...
                {caseStudy.solution && (
                  <div>
                    ...
                    <div className="bg-[var(--aio-info-surface)] rounded-lg p-6">
                      <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">
                        {caseStudy.solution}
                      </p>
                    </div>
