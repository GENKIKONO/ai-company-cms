...
async function getPost(slug: string, postId: string, isPreview: boolean = false): Promise<Post | null> {
  try {
    ...
    logger.error('Failed to fetch post', { data: error instanceof Error ? error : new Error(String(error)) });
    return null;
  }
}
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <Link 
              ...
              className="inline-flex items-center text-[var(--aio-primary)] hover:text-[var(--aio-primary)] transition-colors"
            >
