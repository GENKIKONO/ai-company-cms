...
function ResetPasswordConfirmContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error('Password update error:', { data: err });
      setError('パスワードの更新に失敗しました。もう一度お試しください。');
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full space-y-8 p-8">
          ...
          <div className="text-center">
            ...
            <div className="mt-4">
              <Link href="/auth/forgot-password" className="font-medium text-[var(--aio-primary)] hover:text-[var(--aio-primary)]">
...
export default function ResetPasswordConfirmPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-[var(--aio-primary)] mx-auto"></div>
