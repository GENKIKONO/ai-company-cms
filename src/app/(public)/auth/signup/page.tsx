            ...
            <div className="bg-red-50/80 backdrop-blur-sm border border-red-200 text-red-700 px-6 py-4 rounded-2xl">
              ...
              {error.includes('すでに登録されています') && (
                <div className="mt-3 text-sm">
                  <Link href="/auth/login" className="text-[var(--aio-primary)] hover:text-[var(--aio-primary)] underline mr-4">
                    ログインページへ
                  </Link>
                  <Link href="/auth/forgot-password" className="text-[var(--aio-primary)] hover:text-[var(--aio-primary)] underline">
                    パスワードリセット
                  </Link>
                </div>
              )}
