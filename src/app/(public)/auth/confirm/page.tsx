    ...
    const handleEmailConfirmation = async () => {
      try {
        ...
        if (token_hash) {
          ...
          if (verifyError) {
            logger.error('Email verification error:', { data: verifyError });
        ...
        // tokenがある場合（従来形式のサポート）
          ...
          if (verifyError) {
            logger.error('Token verification error:', { data: verifyError });
        ...
        logger.error('Confirmation error:', { data: err });
          ...
          <div className="text-center">
            ...
            <div className="mt-6 space-y-4">
              <button
                ...
                className="w-full flex justify-center py-2 px-4 border border-[var(--aio-info-border)] rounded-md text-sm font-medium text-[var(--aio-primary)] bg-white hover:bg-[var(--aio-info-surface)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--aio-primary)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {resendLoading 
                  ? '再送信中...' 
                  : retryAfter !== null 
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full space-y-8 p-8">
          <div className="text-center">
            ...
            <div className="mt-6">
              <Link href="/organizations/new" className="font-medium text-[var(--aio-primary)] hover:text-[var(--aio-primary)]">
                今すぐ企業情報を登録
              </Link>
            </div>
          </div>
