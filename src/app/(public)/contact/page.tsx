      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 section-spacing">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/60 p-8 lg:p-12">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-[var(--aio-info-surface)] border border-[var(--aio-info-border)]/60 p-6 rounded-2xl">
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                詳細は <Link href="/privacy" className="text-[var(--aio-primary)] hover:text-[var(--aio-primary)] underline font-medium transition-colors duration-200">プライバシーポリシー</Link> をご確認ください。
              </p>
            </div>
