      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button className="w-full mt-4 text-[var(--aio-primary)] hover:text-[var(--aio-primary)] text-sm font-medium">
              すべての活動を見る
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <button className="w-full text-left p-3 bg-[var(--aio-info-surface)] hover:bg-[var(--aio-info-surface)] rounded-lg transition-colors">
