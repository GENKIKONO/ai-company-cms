...
export const aioCopy = {
    ...
    categories: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: 'AI検索の普及により、AIが直接回答を生成する機会が増加しています。従来のSEOに加えて、AIが理解しやすい構造化された情報提供が企業の発見性向上に有効と考えられています。'
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            answer: 'Starterプランの全機能をお試しいただけます。JSON-LD生成・SEO最適化機能をご体験いただき、その効果をご確認いただけます。クレジットカード登録なしで始められます。'
          },
          {
  ...
  cta: {
    title: 'AIOで、今すぐ始める\n企業情報の構造化',
    description: '14日間無料トライアル。簡単な入力で、あなたの企業情報のAI最適化をサポートします。',
    ...
    disclaimer: '本サービスは、構造化データの出力など技術的支援を提供するものです。検索順位の向上、AI検索での掲載・引用、その他の具体的な成果については保証いたしかねます。効果には個社差があります。'
  },
