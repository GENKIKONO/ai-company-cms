    ...
    async function fetchData() {
      ...
      try {
        ...
        if (orgsData.data && Array.isArray(orgsData.data)) {
          ...
          setOrganizations([]);
          logger.warn('Organizations API returned no data array:', { data: orgsData });
        }
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[var(--aio-primary)] hover:bg-[var(--aio-primary-hover)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--aio-info)]"
            >
              再読み込み
            </button>
          </div>
