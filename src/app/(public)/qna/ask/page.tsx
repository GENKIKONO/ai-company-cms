...
function AskQuestionForm() {
  ...
  const loadOrganizations = async () => {
    try {
      ...
      logger.error('Failed to load organizations', { data: error instanceof Error ? error : new Error(String(error)) });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error('Question submission failed', { data: error instanceof Error ? error : new Error(String(error)) });
