...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('[Partners API] Unexpected error in GET', error instanceof Error ? error : new Error(String(error)));
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('[Partners API] Unexpected error in POST', error instanceof Error ? error : new Error(String(error)));
