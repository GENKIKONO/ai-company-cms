...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('[Partners Dashboard] Unexpected error', error instanceof Error ? error : new Error(String(error)));
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('[Partners Dashboard] Error updating preferences', error instanceof Error ? error : new Error(String(error)));
