...
export class ABTestManager {
  ...
  private sendAnalyticsEvent(eventName: string, data: AnalyticsEventData): void {
    ...
    if (typeof window !== 'undefined' && (window as any).plausible) {
      try {
        ...
        logger.warn('Failed to send event to Plausible', { data: { component: 'ab-testing', error: error.message } });
      }
    }
  ...
  private loadFromStorage(): void {
    ...
    try {
      ...
      logger.warn('Failed to load A/B test data from storage', { data: { component: 'ab-testing', error: error.message } });
    }
  }
  ...
  private saveToStorage(): void {
    ...
    try {
      ...
      logger.warn('Failed to save A/B test data to storage', { data: { component: 'ab-testing', error: error.message } });
    }
  }
  ...
  private saveAssignmentToStorage(identifier: string, testId: string, variant: string): void {
    ...
    try {
      ...
      logger.warn('Failed to save assignment to storage', { data: { component: 'ab-testing', error: error.message } });
    }
  }
}
