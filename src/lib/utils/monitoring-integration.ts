...
export class MonitoringIntegration {
  ...
  async getSystemHealth(): Promise<SystemHealthStatus> {
    ...
    try {
      ...
      logger.error('System health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
  ...
  private async checkSentryHealth(): Promise<boolean> {
    ...
    try {
      ...
      logger.error('Sentry health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
      return false;
    }
  }
  ...
  private async checkSlackHealth(): Promise<boolean> {
    ...
    try {
      ...
      logger.error('Slack health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
      return false;
    }
  }
  ...
  private async checkPlausibleHealth(): Promise<boolean> {
    ...
    try {
      ...
      logger.error('Plausible health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
      return false;
    }
  }
  ...
  private async checkWebhookHealth(): Promise<boolean> {
    ...
    try {
      ...
      logger.error('Webhook health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
      return false;
    }
  }
  ...
  private async checkStripeHealth(): Promise<boolean> {
    try {
      ...
      logger.error('Stripe health check failed', { data: error instanceof Error ? error : new Error(String(error)) });
      return false;
    }
  }
  ...
  async processAlerts(): Promise<void> {
    try {
      ...
      logger.error('Failed to process alerts', { data: error instanceof Error ? error : new Error(String(error)) });
