...
export async function getOrganizations(options: {
  ...
  try {
    ...
    logger.error('Error fetching organizations', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function updateOrganization(id: string, organizationData: Partial<OrganizationFormData>) {
  try {
    ...
    if (typeof window !== 'undefined') {
      ...
      logger.debug('✅ Organization updated, server cache invalidated');
    }
    
    return { data: result.data, error: null };
  } catch (error) {
    logger.error('Error updating organization', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function updateOrganizationStatus(id: string, status: 'draft' | 'published' | 'archived') {
  try {
    ...
    logger.error('Error updating organization status', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function getOrganizationStats() {
  try {
    ...
    logger.error('Error fetching organization stats', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function getIndustries() {
  try {
    ...
    logger.error('Error getting industries', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: [], error };
  }
}
...
export async function globalSearch(options: {
  ...
  try {
    ...
    logger.error('Error performing global search', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function getServiceCategories() {
  try {
    ...
    logger.error('Error fetching service categories', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: [], error };
  }
}