...
export async function checkHearingPermission(
  ...
  try {
    ...
    logger.error('Permission check error', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function checkActiveDelegation(
  ...
  try {
    ...
    logger.error('Delegation check error', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function checkRateLimit(
  ...
  try {
    ...
    if (error) {
      logger.error('Rate limit check error', { data: error instanceof Error ? error : new Error(String(error)) });
