...
export async function getFAQs(organizationId: string) {
  try {
    ...
    logger.error('Error fetching FAQs', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function getFAQ(faqId: string) {
  try {
    ...
    logger.error('Error fetching FAQ', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function createFAQ(organizationId: string, faqData: FAQFormData) {
  try {
    ...
    logger.error('Error creating FAQ', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function updateFAQ(faqId: string, faqData: Partial<FAQFormData>) {
  try {
    ...
    logger.error('Error updating FAQ', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function deleteFAQ(faqId: string) {
  try {
    ...
    logger.error('Error deleting FAQ', { data: error instanceof Error ? error : new Error(String(error)) });
    return { error };
  }
}
...
export async function reorderFAQs(organizationId: string, faqIds: string[]) {
  try {
    ...
    logger.error('Error reordering FAQs', { data: error instanceof Error ? error : new Error(String(error)) });
    return { error };
  }
}
...
export async function getFAQCategories() {
  try {
    ...
    logger.error('Error fetching FAQ categories', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: [], error };
  }
}
