...
export class AnalyticsEngine {
  ...
  static async trackEvent(event: Omit<AnalyticsEvent, 'timestamp'>): Promise<void> {
    try {
      ...
      logger.error('Failed to track analytics event', { data: error instanceof Error ? error : new Error(String(error)) });
    }
  }
  ...
  static async getUsageMetrics(
    ...
    try {
      ...
      logger.error('Failed to get usage metrics', { data: error instanceof Error ? error : new Error(String(error)) });
      return {
  ...
  static async getContentMetrics(
    ...
    try {
      ...
      logger.error('Failed to get content metrics', { data: error instanceof Error ? error : new Error(String(error)) });
      return {
        popular_organizations: [],
        popular_services: [],
  ...
  static async getBusinessMetrics(
    ...
    try {
      ...
      logger.error('Failed to get business metrics', { data: error instanceof Error ? error : new Error(String(error)) });
      return {
