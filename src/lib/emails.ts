...
export async function sendWelcomeEmail(email: string, userName: string) {
  try {
    ...
    if (error) {
      logger.error('Error sending welcome email', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function sendPaymentFailedEmail(
  ...
  try {
    ...
    if (error) {
      logger.error('Error sending payment failed email', { data: error instanceof Error ? error : new Error(String(error)) });
      return { success: false, error };
    }
...
export async function sendEmail({
  ...
  try {
    ...
    if (error) {
      logger.error('Error sending email', { data: error instanceof Error ? error : new Error(String(error)) });
      return { success: false, error };
    }
