...
export async function getCaseStudies(organizationId: string) {
  try {
    ...
    logger.error('Error fetching case studies', { data: error instanceof Error ? error : new Error(String(error)) });
...
export async function getCaseStudy(caseStudyId: string) {
  try {
    ...
    logger.error('Error fetching case study', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function createCaseStudy(organizationId: string, caseStudyData: CaseStudyFormData) {
  try {
    ...
    logger.error('Error creating case study', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function updateCaseStudy(caseStudyId: string, caseStudyData: Partial<CaseStudyFormData>) {
  try {
    ...
    logger.error('Error updating case study', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: null, error };
  }
}
...
export async function deleteCaseStudy(caseStudyId: string) {
  try {
    ...
    logger.error('Error deleting case study', { data: error instanceof Error ? error : new Error(String(error)) });
    return { error };
  }
}
...
export async function getClientIndustries() {
  try {
    ...
    logger.error('Error fetching client industries', { data: error instanceof Error ? error : new Error(String(error)) });
    return { data: [], error };
  }
}
