...
export async function performAdvancedSearch(
  ...
  try {
    ...
    logger.error('Advanced search error', { data: error instanceof Error ? error : new Error(String(error)) });
    return results;
  }
}
...
async function searchOrganizations(filters: AdvancedSearchFilters) {
  ...
  if (error) {
    logger.error('Organization search error', { data: error instanceof Error ? error : new Error(String(error)) });
...
async function searchServices(filters: AdvancedSearchFilters) {
  ...
  if (error) {
    logger.error('Service search error', { data: error instanceof Error ? error : new Error(String(error)) });
...
async function searchCaseStudies(filters: AdvancedSearchFilters) {
  ...
  if (error) {
    logger.error('Case study search error', { data: error instanceof Error ? error : new Error(String(error)) });
...
async function getFacets(filters: AdvancedSearchFilters) {
  ...
  try {
    ...
    logger.error('Facets fetch error', { data: error instanceof Error ? error : new Error(String(error)) });
  }
...
export async function getSearchSuggestions(query: string, limit = 10): Promise<string[]> {
  ...
  try {
    ...
    logger.error('Search suggestions error', { data: error instanceof Error ? error : new Error(String(error)) });
    return [];
  }
}