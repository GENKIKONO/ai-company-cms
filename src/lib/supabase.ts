...
export async function selectFrom<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database select error:', { data: error })
    ...
    logger.error('Database select exception:', { data: dbError })
...
export async function selectSingle<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database select single error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database select single exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function insertInto<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database insert error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database insert exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function updateRecord<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database update error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database update exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function upsertRecord<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database upsert error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database upsert exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function deleteRecord<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    logger.error('Database delete exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function countRecords<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database count error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database count exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function recordExists<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database exists check error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database exists exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function searchRecords<T extends keyof SupabaseDatabase['public']['Tables']>(
  ...
  try {
    ...
    if (error) {
      logger.error('Database search error:', { data: error })
      return { data: null, error: error as DatabaseError }
    }
    ...
    logger.error('Database search exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
...
export async function withTransaction<T>(
  ...
  try {
    ...
    logger.error('Database transaction exception:', { data: dbError })
    return { data: null, error: dbError }
  }
}
