-- Unify role management system
-- Make app_users table the single source of truth for user roles
...
-- Update the unified role getter function
...
-- Update is_admin function to use unified role system
-- Note: Skip this function creation as it's already defined in cleanup script
...
BEGIN
  ...
  WHERE user_id = get_user_access_summary.user_id;
...
DO $$
BEGIN
  RAISE NOTICE 'Role management system unified successfully';
END $$;